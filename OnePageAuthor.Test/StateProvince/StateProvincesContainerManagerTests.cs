...
{
    public class StateProvincesContainerManagerTests
    {
        private readonly Mock<Database> _databaseMock;
        private readonly Mock<Container> _containerMock;
        private readonly StateProvincesContainerManager _containerManager;

        public StateProvincesContainerManagerTests()
        {
            _databaseMock = new Mock<Database>();
            _containerMock = new Mock<Container>();
            _containerManager = new StateProvincesContainerManager(_databaseMock.Object);
        }
        ...
        {
            // Act & Assert
            var exception = Assert.Throws<ArgumentNullException>(() => new StateProvincesContainerManager(null!));
