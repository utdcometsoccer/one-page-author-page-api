...
namespace InkStainedWretch.OnePageAuthorAPI.Functions
{
    ...
    /// - Method: GET
    /// - Route: /api/inkadmin/domain-registrations
    ...
    /// - Method: POST
    /// - Route: /api/inkadmin/domain-registrations/{registrationId}/complete
    /// - Auth: Bearer JWT with "Admin" role claim
    ...
    public class AdminDomainRegistrationFunction
    {
        ...
        public async Task<IActionResult> AdminGetIncompleteDomainRegistrations(
            [HttpTrigger(AuthorizationLevel.Anonymous, "get", Route = "inkadmin/domain-registrations")] HttpRequest req)
        {
        ...
        public async Task<IActionResult> AdminCompleteDomainRegistration(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "inkadmin/domain-registrations/{registrationId}/complete")] HttpRequest req,
