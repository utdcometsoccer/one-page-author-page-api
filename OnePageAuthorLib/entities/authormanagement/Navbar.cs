namespace InkStainedWretch.OnePageAuthorAPI.Entities.Authormanagement
{
    public class Navbar : AuthorManagementBase
    {
        ...
        public string? navItems_chooseCulture_ariaLabel { get; set; }
        ...
        public string? navItems_domainRegistration_ariaLabel { get; set; }
        ...
        public string? navItems_authorPage_ariaLabel { get; set; }
        ...
        public string? navItems_subscribe_ariaLabel { get; set; }
        ...
        public string? navItems_thankYou_ariaLabel { get; set; }
    }
}
