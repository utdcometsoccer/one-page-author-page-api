...
```bash
dotnet run -- --domain example.com
```

Tests a specific domain name. Looks up the domain in the database first to get associated metadata.
...
| `--domain` | domain name | Test specific domain (e.g., `example.com`) |
